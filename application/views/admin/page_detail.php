			  ...
			  <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> -->
				<div class="info-box">
					...
					<div class="info-box-content border-right">
						...
						<span align="center" style="color:black" class="info-box-number"><?php echo $get_total_truck['TOTAL_TRUCK']  ?></span>
					</div>
					<div class="info-box-content">
...
<script type="text/javascript">
	...
	var socket1 = io.connect( 'http://'+window.location.hostname+':3001' );
	var socket2 = io.connect( 'http://'+window.location.hostname+':3002' );
  ...
  socket2.on( 'emit_from_server2', function( data ) {
    $( "#message-tbody" ).prepend('<tr><td>99</td><td>'+data.VIPCAM+'</td><td>'+data.VIPCAM+'</td><td>'+data.VLICENSEPLAT+'</td><td>'+setdate+'</td><td>'+settime+'</td></tr>');
    table_capture.ajax.reload();
	});
</script>
